    ...
    (
      ...
      >
        ...
        >
          ...
          <img src="https://ordinals.hiro.so/logo.svg" alt="" width="402px" height="42px" />
        </div>
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          >
            {compatibleTypes.includes(inscription.content_type.toLowerCase()) ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img
                src={`https://ordinals.hiro.so/_next/image?url=${encodeURI(imageUrl)}&w=384&q=100`}
                alt=""
                width="100%"
                height="100%"
                style={{
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span style={{ fontSize: '38px', marginRight: '20px' }}>Inscription </span>
              <div
                style={{
                  display: 'flex',
                  padding: '12px 18px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              ...
              <div style={{ display: 'flex' }}>
                ...
                <span style={{ textDecoration: 'underline' }}>{inscription.content_type}</span>
              </div>
            </div>
          </div>
        </div>
