...
// todo: aeonik font?
// const inter = localFont({ src: Images.ASSETS.INTER_TTF, display: 'swap' })

// todo: remove ts-ignores
const Charts = ({ data, dataCumulative }: { data: [number, number][]; dataCumulative: [number, number][] }) => {
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-neutral-400">The number of new inscribed sats per block by block height</p>
      ...
      <p className="text-neutral-400">The cumulative number of inscribed sats by block height</p>
      <div className="my-8 relative aspect-video" ref={graphCumulativeRef}></div>
    </div>
  )
}
